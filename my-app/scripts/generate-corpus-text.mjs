...
const countsMatchSealedScope = fragments.length === 345
  && fragments.filter((fragment) => fragment.scope_class === "section_body").length === 345
  && fragments.filter((fragment) => fragment.scope_class === "small_text").length === 0;
